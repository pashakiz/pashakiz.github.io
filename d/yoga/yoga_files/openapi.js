...
if (!VK.Widgets) {
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    var handler         = paramsExtra.ads_handler;
    var handlerFailOnly = !!paramsExtra.ads_handler_fail_only;
    delete paramsExtra.ads_handler;
    delete paramsExtra.ads_handler_fail_only;
